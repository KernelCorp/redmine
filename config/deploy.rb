...
set :site_domain, 'redmine.kerweb.ru/'
set :rails_env, 'production'
set :user, 'mkonin'
#set :domain, 'mkonin@137.117.230.217'
set :domain, "#{user}@137.117.230.217"
...
set :scm, :git
set :repository, 'https://github.com/KernelCorp/redmine.git'
set :branch, 'deploy' # Ветка из которой будем тянуть код для деплоя.
